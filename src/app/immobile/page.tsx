...
export default function Immobile() {
    return (
        <>
            ...
            <button className="btn bg-secondary text-white hover:text-black w-40 mx-16">PARA VENDA</button>

            <div className="flex flex-row justify-around w-full mt-10">
                <div className="">
                    <p className="font-bold text-5xl mb-5">Casa com piscina</p>

                    <p className="text-xl">R. Napoleão Bonaparte, Morada Nobre, n° 1004 - Barreiras - BA</p>
                </div>
            ...
            <div className="flex flex-row justify-between w-full my-10 px-16 gap-5">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="h-2/4 w-142">
                        <iframe className="w-full h-full rounded-3xl" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20Street,%20Dublin,%20Ireland+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                        </iframe>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row px-16">
                <div className="flex flex-col">
                    <div className="w-11/12">
                        ...
                        <p className="mt-5 text-lg">Descubra o lar dos seus sonhos nesta deslumbrante residência, ideal para quem busca conforto, sofisticação e lazer. Localizada em um bairro nobre, esta casa combina elegância e funcionalidade em cada detalhe.
                            <br />Descubra o lar dos seus sonhos nesta deslumbrante residência, ideal para quem busca conforto, sofisticação e lazer. Localizada em um bairro nobre, esta casa combina elegância e funcionalidade em cada detalhe.
                        </p>
                    </div>
                ...
                <div className="card bg-secondary w-96 row-start-3 justify-self-end">
                    ...
                    <div className="card-body">
                        ...
                        <textarea className="textarea textarea-bordered h-32" placeholder="Digite sua mensagem"></textarea>
