    ...
    return (
        <>
            ...
            <div className="ml-20">
                ...
                <p className="text-lg">Para reservas, dúvidas ou sugestões, estamos sempre à disposição para ajudar. Preencha o <br /> formulário abaixo e nossa equipe entrará em contato o mais breve possível.</p>
            </div>
                ...
                <div className="bg-bg-icons w-2/4 p-10 rounded-3xl">
                    ...
                    <div className="flex justify-between mb-8 gap-5">
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Fulano da Silva" className="input input-bordered w-full max-w-xs" />
                        </label>
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="fulano@email.com" className="input input-bordered w-full max-w-xs" />
                        </label>
                    </div>
                    ...
                    <div className="flex justify-between mb-8 gap-5">
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Assunto de interesse" className="input input-bordered w-full max-w-xs" />
                        </label>
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="(77) 99999-9999" className="input input-bordered w-full max-w-xs" />
                        </label>
                    </div>
